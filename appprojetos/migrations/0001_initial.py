# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-21 20:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ParticipantesProjetos',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('participantes', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='appprojetos.Participantes')),
            ],
        ),
        migrations.CreateModel(
            name='Projetos',
            fields=[
                ...
                ('participantes', models.ManyToManyField(through='appprojetos.ParticipantesProjetos', to='appprojetos.Participantes')),
            ],
        ),
        migrations.AddField(
            model_name='participantesprojetos',
            name='projeto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='appprojetos.Projetos'),
        ),
        migrations.AddField(
